# Falling Penguin Game
# Developed by Shachi Agnihotri
...
while run:
    ...
    if game_over:
        end_text = huge_font.render('Falling Penguin', True, 'black')
        end_text2 = font.render('Game Over: Press Enter to Restart', True, 'black')
        end_text3 = font.render('Developed by Shachi Agnihotri', True, 'black')
        screen.blit(end_text, (100, 20))
        screen.blit(end_text2, (60, 220))
        screen.blit(end_text3, (90, 80))
        player_y = - 300
        y_speed = 0
    ...
    screen.blit(score_text, (10, HEIGHT - 130))
    if score > high_score:
        high_score = score
    score_text2 = font.render(f'High Score: {high_score}', True, 'black')
    screen.blit(score_text2, (10, HEIGHT  - 90))
